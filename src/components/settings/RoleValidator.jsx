...
const RoleValidator = () => {
  ...
  return (
    <>
        ...
        <div className="role_container">
          ...
          <form onSubmit={becomeValidator}>
            ...
            <div className="diploma_target">
              ...
              <div className="desc">
                Загрузите диплом кандидата или доктора наук для того, чтобы наши
                администраторы могли проверить вашу квалификацию
              </div>
              {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
              <label className="file_input" id="dropContainer">
                ...
                {err?.images ? (
                  <div className="image_err">Загрузить фотографии</div>
                ) : (
                  ''
                )}
                <input
      ...
      />
      <Modal isStrong onOpen={v => setSuccesModal(v)} isOpen={succesModal}>
        <SuccesModalStyle>
          <div className="title">
            Вы успешно прошли верификацию и стали рецензентом.
          </div>
          <div className="text">
