...
const WritingReview = ({ selectWork = {}, setSelectWork = () => {} }) => {
  const [tab, setTab] = useState(1);
  const navigate = useNavigate();
  const params = useParams();
  const { t } = useTranslation();
  const dispatch = useDispatch();
  const [work, setWork] = useState(selectWork);
  ...
  const getReview = workId => {
    // dispatch({type: 'SET_LOADING', payload:  true})
    Axios()
      .get(`/work_review/${workId}`)
      .then(res => {
  ...
  const HandleNext = () => {
    setTab(tab + 1);
    if (tab === 4) navigate('/validator/writing-review/successfully');
    window.scroll({
      top: 0,
      left: 0,
      behavior: 'smooth',
  ...
  const handleQuestion = (n, v) => {
    if (v === -1) {
      const q = obj?.questionnaire?.questions ?? {};
      delete q[v];
      setObj({
        ...obj,
                ...
                <div className="box-card">
                  <div className="btns-writing">
                    ...
                    <div className="btns-writing-items">
                      ...
                      <div className="add-author">
                        <button type="button" className="review-article">
                          Обзорная статья
                        </button>
                      </div>
                    </div>
                              ...
                              <div className="roise">
                                {get(
                                  ...
                                  <img
                                    src="/img/ellipse_7.svg"
                                    alt=""
                                    onClick={() => handleQuestion(ques?.id, 1)}
                                  />
                                )}
                                <div className="roise_item">Не согласен</div>
                              </div>
                              <div className="roise">
                                {get(
                                  obj,
                                  ...
                                  <img
                                    src="/img/ellipse_7.svg"
                                    alt=""
                                    onClick={() => handleQuestion(ques?.id, 2)}
                                  />
                                )}
                              ...
                              <div className="roise">
                                {get(
                                  ...
                                  <img
                                    src="/img/ellipse_7.svg"
                                    alt=""
                                    onClick={() => handleQuestion(ques?.id, 3)}
                                  />
                                )}
                              ...
                              <div className="roise">
                                {get(
                                  ...
                                  <img
                                    src="/img/ellipse_7.svg"
                                    alt=""
                                    onClick={() => handleQuestion(ques?.id, 4)}
                                  />
                                )}
                                <div className="roise_item">
                                  Скорее согласен
                              ...
                              <div className="roise">
                                {get(
                                  ...
                                  <img
                                    src="/img/ellipse_7.svg"
                                    alt=""
                                    onClick={() => handleQuestion(ques?.id, 5)}
                                  />
                                )}
