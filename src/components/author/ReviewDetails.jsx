              ...
              <div className="article-detail">
                ...
                <div className="article-detail-items">
                  ...
                  <p>
                    ...
                    людей различных социальных групп. В данной статье приводятся
                    принципы построения текста на ясном языке, указывается
                    важность понимания отдельных слов и предложений, приводятся
                    правила и даются рекомендации по составлению новостных
                    текстов. При написании статьи используются методы
                    стратификации, сопоставительного анализа, а также
                    описательный метод. Приведенные в статье правила были
                    получены благодаря людям, практикующим ясный язык, который
                    является инструментом включения определенных социальных
                    групп в общественную, культурную, политическую жизнь
                    общества. <br />
                    Статья посвящена проблеме написания текстов на ясном языке
                    (leichte Sprache). В ней указывается важность применения
                    ясного языка как средства интеграции в общественную жизнь
                        ...
                        <Thead>
                          <Tr className="article-detail-tr__head">
                            ...
                            <Th className="rt_title">
                              {t('review_details.dontAgree')}
                            </Th>
                            <Th className="rt_title">
                              {t('review_details.ratherDontAgree')}
                            </Th>
                            <Th className="rt_title">
                              {t('review_details.neutral')}
                            </Th>
                            <Th className="rt_title">
                              {t('review_details.ratherAgree')}
                            </Th>
                            <Th className="rt_title">
                              {t('review_details.agree')}
                            </Th>
                          </Tr>
                        </Thead>
                        <Tbody>
