...
const CreateArticle = () => {
  ...
  const addAuthorToast = (text = '') => {
    toast({
      ...
      render: () => (
        ...
        >
          <img style={{ marginRight: '14px' }} src="/img/vector.svg" alt="" />
          {text || 'Приглашение отправлено успешно'}
        </Box>
      ),
    });
  };
  ...
  return (
    <div>
          ...
          <div className="create">
            ...
            <div className="steps">
              {[
                {
                  id: 1,
                  name: t('create_article.paperInfo'),
                  step: t('create_article.step1'),
                },
                {
                  id: 2,
                  name: t('create_article.paperText'),
                  step: t('create_article.step2'),
                },
                {
                  id: 3,
                  name: t('create_article.preView'),
                  step: t('create_article.step3'),
                },
                {
                  id: 4,
                  name: t('create_article.publishPaper'),
                  step: t('create_article.step4'),
                },
              ].map(e => (
            ...
            tab === 5 ? (
              <div className="box-card">
                ...
                <div className="upload-file">
                  ...
                  <div className="upload-file__p">
                    <p>
                      Перенесите файл PDF в эту область или выберите его вручную{' '}
                    </p>
                  </div>
                  <span>{t('create_article.fileLimitIs50mb')}</span>
                  <button type="button">
                    {t('create_article.chooseFile')}
                  </button>
                </div>
                  ...
                  <div className="image">
                    <div className="info">
                      ...
                      <div className="img_info">
                        <div className="name">sow_article_to_publish.jpg</div>
              ...
              <div className="box-card">
                ...
                <div className="internet-space">
                  ...
                  <div className="annotation">
                    ...
                    <p>
                      {(newWord?.work?.Tags ?? []).map(tag => (
                        <span className="tag" key={Math.random() * Date.now()}>
                          {tag}
                        </span>
                      ))}
                    </p>
              ...
              <div>
                <div className="box-card">
                  ...
                  <div className="placement-title">
                    <img src="/img/star_icon.svg" alt="" />
                    <h5>{t('create_article.deleteAndEdit')}</h5>
                  </div>
                  <div className="placement-text">
            ...
            <div className="btns box-card">
              ...
              tab === 1 ? (
                // eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
                <div onClick={CreateAuthorStepOne} className="next-button btn">
      ...
      <Modal isOpen={modalOpenadmin} onOpen={setmodalOpenadmin} isStrong>
