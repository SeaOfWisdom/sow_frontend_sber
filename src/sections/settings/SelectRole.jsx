      ...
      <div className="navbar">
        <NavLink to="/select-author" className="link link1">
          ...
          <div>
            ...
            <div className="desc">
              Владеет собственностью на свою работу (NFT), которая публикуется и
              приносит вознаграждение каждый раз, когда кто-то ее читает
            </div>
          </div>
        </NavLink>
        <NavLink to="/select-validator" className="link link2">
          ...
          <div>
            ...
            <div className="desc">
              Проверяет представленные работы и получает вознаграждение за
              легитимные работы
            </div>
          </div>
        </NavLink>
