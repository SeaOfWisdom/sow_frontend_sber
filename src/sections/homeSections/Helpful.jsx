                    ...
                    <div className="card_body">
                        ...
                        <div>
                            ...
                            <div className="author">
                                <span className="alink plink disabled_link">{t('helpful.findArticle')}</span>
                            </div>
                        </div>
                    </div>
                </div> 
                <div  className="card">
                    <div className="card_body">
                        ...
                        <div>
                            ...
                            <div className="author">
                                <Link to='/library' className="alink">{t('helpful.viewLibrary')}</Link>
                            </div>
                        </div> 
                    </div>
                </div>
                    ...
                    <div className="card_body">
                        ...
                        <div>
                            ...
                            {(walletData?.isConnect && isWalletConnect() && localStorage.getItem('accountAddress'))?<>
                                <Link  to='/library' className="alink">{t('helpful.becomeAuthor')}</Link>
                            </>:<> 
                                <span className="alink"   onClick={() => dispatch({type: 'SET_OPEN_AUTH', payload: true})}>{t('helpful.becomeAuthor')}</span>
                            </>}</>:<>
                                <span className="alink plink disabled_link">{t('helpful.becomeAuthor')}</span>
                            </>} 
                            </div>
                        </div> 
                    </div>
