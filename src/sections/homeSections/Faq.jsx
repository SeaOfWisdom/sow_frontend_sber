          ...
          <div className="faq">
            <div className="faqs">
              <div className="items">
                {faqs.map((item, index) => (
                  <div
                    className={active === (index+'faq1') ? "item active" : "item"}
                    key={(index+'faq1')}
                    onClick={() => {
                      setActive(active === (index+'faq1') ? -1 : (index+'faq1') );
                    }}
                  >
            ...
            <div className="faqs">
              <div className="items">
                {faqs2.map((item, index) => (
                  <div
                    className={active === (index+'faq2') ? "item active" : "item"}
                    key={(index+'faq2')}
                    onClick={() => {
                      setActive(active === (index+'faq2') ? -1 : (index+'faq2'));
                    }}
                  >
                    <div className="ftitle">
                      <h4>{item?.name}</h4>
